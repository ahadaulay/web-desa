                ...
                <div class="container-xxl py-5">
                    <div class="container">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">Statistik Profesi Penduduk</h1>
                            <p>Jumlah dan jenis profesi yang terdapat pada desa DELISAOS adalah sebagai berikut</p>
                            <img width="250px" height="250px" src="{{asset('sneat')}}/assets/img/favicon/profesi.png" alt="">
                        </div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# of Peserta',
                data: {!! json_encode($profesiCounts) !!},
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
