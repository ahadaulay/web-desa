                ...
                <div class="container-xxl py-5">
                    <div class="container">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">Statistik Agama Penduduk</h1>
                            <p>Jumlah dan agama yang dianut masyarakat pada desa DELISAOS adalah sebagai berikut</p>
                            <img width="250px" height="250px" src="{{asset('sneat')}}/assets/img/favicon/agama.png" alt="">
                        </div>
