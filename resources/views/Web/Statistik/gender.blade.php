                ...
                <div class="container-xxl py-5">
                    <div class="container">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                            <h1 class="mb-3">Statistik Gender Penduduk</h1>
                            <p>Gender masyarakat pada desa DELISAOS adalah sebagai berikut</p>
                            <img width="250px" height="250px" src="{{asset('sneat')}}/assets/img/favicon/gender.png" alt="">
                        </div>
                        ...
                        <div class="container bg-white rounded p-3">
                            <div class="row g-3">
                                ...
                                @foreach ($jenisKelaminArray as $data)
                                {{-- card-start --}}
                                <div class="col-lg-4 col-sm-3 wow fadeInUp" data-wow-delay="0.1s">
                                    <a class="cat-item d-block bg-light text-start rounded p-3" href="">
                                        <div class="rounded p-4">
                                            <h4 class="mb-3">{{ $data['jenis_kelamin'] }}</h4>
                                            <h5>{{ $data['jumlah'] }}</h5>
                                        </div>
                                    </a>
                                </div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# of Peserta',
                data: {!! json_encode($jenisKelaminCounts) !!},
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
