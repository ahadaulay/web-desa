    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-primary">
          <h4 class="card-title text-white ">BERITA</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
            <a href="/admin/berita/create">
              <button type="button" class="btn btn-primary m-3 ml-3" >Tambah Berita</button>
            </a>  
          </div>
          <!-- table hover -->
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="/admin/berita/{{$w->id}}/edit">
                          <button type="button" class="btn btn-warning m-3" >EDIT</button>
                        </a>

                        <form action="/admin/berita/{{$w->id}}/destroy" method="POST">
                          @csrf
                          @method('delete')
