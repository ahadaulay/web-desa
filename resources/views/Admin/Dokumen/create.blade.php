...
<section id="basic-4zontal-layouts">
    <div class="row match-height">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="/admin/dokumen/store" enctype="multipart/form-data" method="POST" class="form form-horizontal">
                    @csrf
                <div class="form-body">
                    <div class="row">
                    ...
                    <div class="col-md-8 form-group mb-3">
                        <input required type="file" id="first-name" class="form-control" name="dokumen" placeholder="Masukkan dokumen ">
                    </div>
