...
<section id="basic-4zontal-layouts">
    <div class="row match-height">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="/layanan/store" enctype="multipart/form-data" method="POST" class="form form-horizontal">
                    @csrf
                <div class="form-body">
                    <div class="row">
                    ...
                    <div class="col-md-8 form-group mb-3">
                        <input required type="text" id="first-name" class="form-control" name="deskripsi" placeholder="Masukkan deskripsi">
                    </div>
