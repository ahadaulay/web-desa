        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="/layanan/{{$data->id}}" enctype="multipart/form-data" method="POST" class="form form-horizontal">
                            @csrf
                            @method('put')
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group mb-3">
                                        <input required value="{{ $data->deskripsi }}" type="text"  class="form-control" name="deskripsi" placeholder="Masukkan deskripsi">
                                    </div>
